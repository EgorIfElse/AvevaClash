...
{
    public class DateSubstracts
    {
        public double DateSubstract(double d1, double m1, double y1, double d2, double m2, double y2)
        {
        ...
        public string DateAdd(double d1, double m1, double y1, double day)
        {
